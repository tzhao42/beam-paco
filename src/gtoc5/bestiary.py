...
assert (
    score(golden_path) == 16
    and abs(resource_rating(golden_path) - 0.011875988961470869) < 1e-10
...
assert (
    score(spice) == 17
    and abs(resource_rating(spice) - 0.0016809741417127071) < 1e-10
