...
from src.gtoc5.constants import AU, DAY2SEC, EARTH_VELOCITY, MU_SUN, asteroids
...
def edelbaum_dv(ast1, ast2, t):
    ...
    dV = sqrt(vc1 * vc1 - 2.0 * vc1 * vc2 * cos(pi / 2.0 * i_rel) + vc2 * vc2)
    return dV
