...
# Sun's gravitational parameter �_S, m^3/s^2
...
earth = pk.planet.keplerian(
    _earth_op[0], _earth_op[1:], MU_SUN, 398601.19 * 1000 ** 3, 0, 0, "Earth"
)
