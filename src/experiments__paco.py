...
class experiment(object):
    ...
    def __init__(
        ...
        **kwargs
        ...
        if self.pareto_elite:
            assert (
                "pareto" in path_handler.__class__.__name__
    ...
    def set_parameters(self, variant="P-ACO", pareto_elite=False, **kwargs):
        ...
        diff = {
            ...
            "Stochastic Beam": dict(alpha=0.0, beta=1.0),
            # Standard (deterministic) Beam Search
            "Beam Search": dict(alpha=0.0, beta=1.0, prob_greedy=1.0),
        }.get(self.variant, {})
    ...
    def print_best(self):
        ...
        if self.pareto_elite:
            ...
            hv = hypervolume(obj, reference_point=(3500.0, 15.0))
